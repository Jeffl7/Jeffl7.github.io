...
document.addEventListener('DOMContentLoaded', (event) => {
    const cells = document.querySelectorAll('td.wrap');
    cells.forEach(cell => {
        cell.innerHTML = insertBreaks(cell.textContent, 10);
    });
});
...
document.addEventListener('DOMContentLoaded', (event) => {
    const cells = document.querySelectorAll('td.wrap-exchange');
    cells.forEach(cell => {
        cell.innerHTML = insertBreaks(cell.textContent, 16);
    });
});
